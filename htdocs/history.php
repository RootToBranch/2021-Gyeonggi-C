...
<body id="historyPage">
    ...
    <div class="window history_window">
        <div class="history_window_inner">
            <h3>연혁관리</h3>
            
            <label><span>연혁내용</span> <textarea name="" id="history_content" cols="30" rows="10"></textarea></label>
            <label><span>연혁일자</span> <input type="date" id="history_date"></label>


            <button class="historyWindow_confirmBtn">확인</button>
            <label class="historyWindow_closeBtn">⨉</label>
        </div>
    </div>
    ...
    <div class="history section_layout_type1">
        <div class="inner">
            <div class="title row-100">
                ...
                <div>
                    <p>
                        ...
                        <a href="#">무형문화재관리원</a> > 
                        <a href="#">일반현황</a> > <a href="./history.php">연혁</a>
                    </p>
                </div>
            </div>
            <div class="tab-menu">
            ...
            <div class="contentSection">
                <!-- <div class="datefilter active date-2023">
                    <div class="item_list">
                        <div>
